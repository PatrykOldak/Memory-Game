...
function updateScore() {
	...
	.innerHTML = "Liczba odgadniętych: " + score + "/8";
}
...
function win(){
if(score == 8){
document.getElementById("info").innerHTML = "Wygrała Pani! :-)";
}
}

function lose(){
	if(moves >= availableMoves) {
	document.getElementById("info").innerHTML = "Przegrała Pani! :-("
	var loser = document.getElementsByClassName("hidden");
	var amount = loser.length;
	for (var i = 0; i < amount; i++) {
				loser[0].className = "scored";
		}
	}
